...
<main class="dashboard-main" style="margin-inline-start: 0">
    <div class="navbar-header border-b border-neutral-200 dark:border-neutral-600">
        <div class="flex items-center justify-between">
            <div>
                <a href="index.html" class="sidebar-logo" style="border: none; padding: 0; height: 0;">
            ...
            <div class="col-auto">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <button data-dropdown-toggle="dropdownProfile"
                        ...
                        type="button">
                        <img src="{{ auth()->guard('user')->user()->foto ? asset('user/' . auth()->guard('user')->user()->foto) : asset('assets/images/user.png') }}"
                            alt="image" class="w-10 h-10 object-fit-cover rounded-full">
